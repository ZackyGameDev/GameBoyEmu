...
uint8_t SM83::SLA_B() { return SHIFTLEFT({B, true}); }
uint8_t SM83::SLA_C() { return SHIFTLEFT({C, true}); }
uint8_t SM83::SLA_D() { return SHIFTLEFT({D, true}); }
uint8_t SM83::SLA_E() { return SHIFTLEFT({E, true}); }
uint8_t SM83::SLA_H() { return SHIFTLEFT({H, true}); }
uint8_t SM83::SLA_L() { return SHIFTLEFT({L, true}); }
uint8_t SM83::SLA_aHL() { return SHIFTLEFT({HL, false}); }
uint8_t SM83::SLA_A() { return SHIFTLEFT({A, true}); }
uint8_t SM83::SRA_B() { return SHIFTLEFT({B, true}, .reversed=true); }
uint8_t SM83::SRA_C() { return SHIFTLEFT({C, true}, .reversed=true); }
uint8_t SM83::SRA_D() { return SHIFTLEFT({D, true}, .reversed=true); }
uint8_t SM83::SRA_E() { return SHIFTLEFT({E, true}, .reversed=true); }
uint8_t SM83::SRA_H() { return SHIFTLEFT({H, true}, .reversed=true); }
uint8_t SM83::SRA_L() { return SHIFTLEFT({L, true}, .reversed=true); }
uint8_t SM83::SRA_aHL() { return SHIFTLEFT({HL, false}, .reversed=true); }
uint8_t SM83::SRA_A() { return SHIFTLEFT({A, true}, .reversed=true); }
...
uint8_t SM83::SRL_B() { return SHIFTLEFT({B, true}, .reversed=true, .is_logical=true); }
uint8_t SM83::SRL_C() { return SHIFTLEFT({C, true}, .reversed=true, .is_logical=true); }
uint8_t SM83::SRL_D() { return SHIFTLEFT({D, true}, .reversed=true, .is_logical=true); }
uint8_t SM83::SRL_E() { return SHIFTLEFT({E, true}, .reversed=true, .is_logical=true); }
uint8_t SM83::SRL_H() { return SHIFTLEFT({H, true}, .reversed=true, .is_logical=true); }
uint8_t SM83::SRL_L() { return SHIFTLEFT({L, true}, .reversed=true, .is_logical=true); }
uint8_t SM83::SRL_aHL() { return SHIFTLEFT({HL, false}, .reversed=true, .is_logical=true); }
uint8_t SM83::SRL_A() { return SHIFTLEFT({A, true}, .reversed=true, .is_logical=true); }
