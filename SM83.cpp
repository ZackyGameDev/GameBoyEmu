...
uint8_t SM83::SLA_B() { return SWAP({B, true}); }
uint8_t SM83::SLA_C() { return SWAP({C, true}); }
uint8_t SM83::SLA_D() { return SWAP({D, true}); }
uint8_t SM83::SLA_E() { return SWAP({E, true}); }
uint8_t SM83::SLA_H() { return SWAP({H, true}); }
uint8_t SM83::SLA_L() { return SWAP({L, true}); }
uint8_t SM83::SLA_aHL() { return SWAP({HL, false}); }
uint8_t SM83::SLA_A() { return SWAP({A, true}); }
uint8_t SM83::SRA_B() { return SWAP({B, true}); }
uint8_t SM83::SRA_C() { return SWAP({C, true}); }
uint8_t SM83::SRA_D() { return SWAP({D, true}); }
uint8_t SM83::SRA_E() { return SWAP({E, true}); }
uint8_t SM83::SRA_H() { return SWAP({H, true}); }
uint8_t SM83::SRA_L() { return SWAP({L, true}); }
uint8_t SM83::SRA_aHL() { return SWAP({HL, false}); }
uint8_t SM83::SRA_A() { return SWAP({A, true}); }
...
uint8_t SM83::SRL_B() { return SWAP({B, true}); }
uint8_t SM83::SRL_C() { return SWAP({C, true}); }
uint8_t SM83::SRL_D() { return SWAP({D, true}); }
uint8_t SM83::SRL_E() { return SWAP({E, true}); }
uint8_t SM83::SRL_H() { return SWAP({H, true}); }
uint8_t SM83::SRL_L() { return SWAP({L, true}); }
uint8_t SM83::SRL_aHL() { return SWAP({HL, false}); }
uint8_t SM83::SRL_A() { return SWAP({A, true}); }
